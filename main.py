...
from components.settings import settings, changeContractId, changeMethodId, changeUrl, changeNetwork,handleSelectedCommunity,cancel,removeCommunity #import the settings function from the settings.py file
